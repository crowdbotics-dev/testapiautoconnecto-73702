...
## Project Structure
    ...
    ├── testapiautoconnecto_73702  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_73702`
...
2. Clone this repo and `cd testapiautoconnecto_73702`
